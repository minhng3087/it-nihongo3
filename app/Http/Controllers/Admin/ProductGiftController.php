...
class ProductGiftController extends Controller
{
	...
	public function store(Request $request)
    {
        ...
        $productGift->save();
        toastr()->success('Thêm mới thành công quà tặng khuyến mại.');
    ...
    public function update(Request $request, $id)
    {
        ...
        $productGift->value = !empty($request->value) ? json_encode( $request->value ) : null;
        $productGift->save();
        toastr()->success('Cập nhật thành công quà tặng khuyến mại.');
    ...
    public function destroy($id)
    {
        ...
        toastr()->success('Xóa thành công quà tặng khuyến mại.');
        return redirect()->back();
    }
}