<?php
define("__IMAGE_DEFAULT__", asset('admin_assets/images/no-image.jpg'));
define("__BASE_URL_FRONTEND__", asset('frontend'));
define("__BASE_URL_BACKEND__", asset('admin_assets'));
...
function renderImage($link)
{
    ...
    return asset('admin_assets/images/no-image.jpg');
}
