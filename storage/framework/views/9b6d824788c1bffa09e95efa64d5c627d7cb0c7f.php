      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo e(url('admin_assets/dist/img/favicon.png')); ?>" class="user-image" alt="User Image">
            <span class="hidden-xs">Quản trị viên</span>
          </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header">
              <img src="<?php echo e(url('admin_assets/dist/img/favicon.png')); ?>" class="img-circle" alt="User Image">
              <p>
...
</header><?php /**PATH /var/www/html/gdigital/resources/views/backend/layouts/header.blade.php ENDPATH**/ ?>