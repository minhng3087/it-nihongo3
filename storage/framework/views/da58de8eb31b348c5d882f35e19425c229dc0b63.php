    ...
    <script>
        $(function() {
            $('#table-ajax').DataTable({
                ...
                serverSide: true,
                ajax: {
                    'url': '<?php echo route('comments.anyData'); ?>',
                    'data': {
                        'cate': '<?php echo e(request()->get('cate')); ?>',
                    }
                },
                columns: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gdigital\resources\views/backend/comments/list.blade.php ENDPATH**/ ?>