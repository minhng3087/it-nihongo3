...
<tr>
	       	...
	       	<div class="image">
	           	<div class="image__thumbnail">
	                ...
	                <i class="fa fa-times"></i></a>
	               	<input type="hidden" value="{{ @$value->image }}" name="content[banner][{{ $id }}][image]"  />
	...
	<td>
		<div class="form-group">
			<label for="">Liên kết</label>
			<input type="text" name="content[banner][{{ $id }}][link]" value="{{ @$value->link }}" class="form-control" required="">
		</div>
		<div class="form-group">
