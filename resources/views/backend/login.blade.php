...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ __BASE_URL_BACKEND__}}/plugins/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page">
    ...
    <!-- iCheck -->
    <script src="{{ __BASE_URL_BACKEND__}}/plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
